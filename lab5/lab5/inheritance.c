...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        newperson->alleles[1]=newperson->parents[1]->alleles[rand() % 2];// TODO: Recursively create blood type histories for parents
    ...
    return newperson;// TODO: Return newly created person
    return NULL;
}
